...
const propertiesData = [
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/300x200',
    logo: 'https://via.placeholder.com/50',
    link: '/suburban-townhouses'
  },
];

const ResidentialProperties = () => {
  // Filter only Residential properties
  const residentialProperties = propertiesData.filter((property) => property.type === 'Residential');
  ...
  return (
    <>
      <section 
        ...
        style={{ backgroundImage: "url('https://prestigecorporatesite.s3.ap-south-1.amazonaws.com/projectimage/5e4a7c7c-6876-40dd-ac01-5754523f6d02.webp')" }} 
      >
        <h1 
